...
int main( int argc , char* argv[] )
{
	...
	sprintf(movie,"convert moving.ppm fr%03d.png",fr);
	//sprintf(movie,"convert -loop 1 -delay 10 *png moving.gif", fr);
	system(movie);
	fclose( fout ) ;
...
agma omp parallel for private(x,y)
