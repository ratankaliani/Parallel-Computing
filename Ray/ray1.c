...
//					double t = fmin(t1,t2);
					...
					triple lamb = {px-ow[s].c.x, py-ow[s].c.y, pz-ow[s].c.z};
			...
			if(hits==-1){
			fprintf(fout, "%i %i %i\n", (int)(.5 * ow[hit].h.r* (1 + multi)),(int)(.5 * ow[hit].h.g* (1 + multi)),(int)(.5 * ow[hit].h.b* (1 + multi)));
			}
